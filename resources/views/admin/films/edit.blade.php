...
<div class="col-md-9 col-lg-10 px-md-4 mt-3">
    <h1>Edit Film</h1>
    <hr>
    <form action="/datafilms/{{ $film->id }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="mb-3">
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <input type="number" name="ticketAvailable" class="form-control form-control @error('ticketAvailable') is-invalid @enderror" value="{{ old('ticketAvailable', $film->ticketAvailable) }}">
            ...
            <div class="col">
                ...
                <input type="number" name="seatAvailable" class="form-control form-control @error('seatAvailable') is-invalid @enderror" value="{{ old('seatAvailable', $film->seatAvailable) }}">
                @error('seatAvailable')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <input type="date" name="date" class="form-control form-control @error('date') is-invalid @enderror" value="{{ old('date', $film->date) }}">
                @error('date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col">
                ...
                <input type="time" name="time" class="form-control form-control @error('time') is-invalid @enderror" value="{{ old('time', $film->time) }}">
                @error('time')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
